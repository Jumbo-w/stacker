...
const unsigned long POWER_BUTTON_CODE = BD42FF00; // power on/off
const unsigned long VOLUME_UP_BUTTON_CODE = B946FF00; // volume up
const unsigned long VOLUME_DOWN_BUTTON_CODE = EA15FF00; // volume down
